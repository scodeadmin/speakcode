...
class lvm_storage_customremove
{
/**
...
var $lang = array();
	...
	function action() {
		...
		$t = $this->response->html->template($this->tpldir.'/lvm-storage-customremove.tpl.php');
	...
	function get_response() {
		...
		$form = $response->get_form($this->actions_name, 'customremove');
		$response->form = $form;
		return $response;
	}
